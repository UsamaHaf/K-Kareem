...
public class ChooseRegFrontActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_choose_reg_front);

        Bundle objetbundle = this.getIntent().getExtras();
        id_driver = objetbundle.getString("id_driver");

        context = ChooseRegFrontActivity.this;
...
//                    progressBar_login.setVisibility(View.VISIBLE);
                    ...
                    new ChooseRegFrontActivity.setUserPhoto().execute();
                }else{
    ...
    private class setUserPhoto extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
            publishProgress();
            String url = AppConst.Server_url+"set_user_reg.php";
                            ...
                            try {
                                ...
                                if(etat.equals("1")){
                                    if(!msg.getString("image").equals("")) {
                                        ...
                                        Intent intent = new Intent(ChooseRegFrontActivity.this, ChooseRegBackActivity.class);
